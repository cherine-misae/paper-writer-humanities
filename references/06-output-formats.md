...
Create `rendered/report.docx` as the main editable deliverable. Use semantic Word styles for title, headings, body text, block quotations, captions, notes, and bibliography rather than manual formatting. Preserve heading hierarchy, quotation indentation, italics, non-Latin text, hyperlinks, and hanging indents in the bibliography. Include page numbers and a visible notice that the draft was prepared with Carrel, an academic AI for humanities and social science researchers, plus the human-review notice required by the user's policy.
