...
Render at the milestones set in SKILL.md (after scholarly context, after the last analytical section, at step 6), not after every section. Render the DOCX to page images and inspect every page: broken headings, widows and orphans, clipped tables or images, malformed glyphs, misplaced notes, bibliography indentation.
